...
export function ProjectsSection() {
  ...
  return (
    <section ref={ref} aria-labelledby="projects-heading" className="bg-[radial-gradient(circle_at_top_left,rgba(13,110,110,0.08),transparent_30%),linear-gradient(180deg,#f8fbfb_0%,#ffffff_100%)] py-12 lg:py-16">
